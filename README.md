...
What this does
Since real employee addresses can't be used, we created 600 made-up (synthetic)
home locations spread across 12 areas in and around Hamburg.
We mapped out the nearby public transport network — the U1 and S1 subway/train
lines and the AKN regional train — including how often trains run on each.
For each synthetic employee, we calculated their full door-to-door travel time:
...
We grouped everyone into four time bands: 30 minutes or less, 31-45 minutes,
46-60 minutes, and over 60 minutes.
We gave each employee a "likelihood to adopt the Deutschlandticket" score out
...
We summarized all of this into an easy-to-read report: what percentage of
